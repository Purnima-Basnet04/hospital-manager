...
<%
    ...
    if (username == null || !userRole.equals("PATIENT")) {
        ...
        response.sendRedirect("../auth/login.jsp?redirect=appointment/book.jsp");
        return;
    }
...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="list.jsp" class="active">Appointments</a></li>
            <li><a href="../common/departments.jsp">Departments</a></li>
            <li><a href="../common/services.jsp">Services</a></li>
    ...
    <div class="container">
        ...
        <form class="appointment-form" action="../AppointmentServlet" method="post">
            ...
            <div class="form-actions">
                ...
                <a href="list.jsp" class="btn secondary">Cancel</a>
            </div>
        </form>
    </div>
